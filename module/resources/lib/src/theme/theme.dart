...
import '../../../../../lib/app/main/values/assets/assets.dart';
...
ThemeData getTheme<T extends AppTheme>(T theme) => ThemeData(
      ...
      datePickerTheme: theme.datePickerThemeData,
      ...
      colorScheme: theme.colorScheme.copyWith(background: theme.backgroundColor),
    );
